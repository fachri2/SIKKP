      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" >
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="kebutuhan-kalori-pasien" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div class="nonex" >Dapur<span class="dashicons dashicons-dismiss"></span></div>
              </a>
            </li>
        </li>
        <!-- Misc -->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 py-4">
                                <div class="card" style="background-color:rgba(122, 191, 255, 0.356);">
                                    <div class="card-body">
                                        <h4 class="card-title">Jumlah Pasien di kamar Rawat Inap: </h4>
                                        <a href="data-konsultasi" class="app-brand-link">
                                            <i class="menu-icon tf-icons bx bx-file"></i>
                                            <h4 class="card-text">{{ $totalPasien}} Pasien</h4>
                                        </a>
                                    </div>
                                </div>
                            </div>
