      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" >
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{route('visitpasien')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-layout"></i>
            ...
            <div class="container flex container-p-y">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="text-center mb-4">Detail Data Konsultasi</h2>
                                <h3 class="text-center mb-4">Data Konsultasi:</h3>
                                <div class="d-flex justify-content-end mb-3">
                                    <a href="{{ route('cetakhasil', ['id'=> $detail->id ])}}" target="_blank" class="btn btn-primary">
                                        <span class="d-flex align-items-center">
                                            <span>Cetak Hasil</span>
                                            <img src="{{ URL::asset('image/printer.png'); }}" class="ms-2" width="20" height="20" alt="">
                                        </span>
                                    </a>
                                </div>
                                <form action="detailpasien" method="get"> 
                                    ...
                                    <table class="table">
                                      <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>:</td>
                                                  <td>{{ $detail->tingkat_kesetresan }}%</td>
                                              </tr>
                                              <tr>
                                              ...
                                              <tr>
                                                ...
                                                <!-- ... other rows ... -->
                                                <!-- Modify the rest of the rows similarly -->
                                                @else
                                                <tr>
