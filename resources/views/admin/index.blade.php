      ...
      <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
        ...
        <main class="container">
          <div class="card">
            <div class="py-3">
            <div class="row">
                <div class="col-md-3 col-sm-5 py-4">
                    <div class="card" style="background-color:rgba(122, 191, 255, 0.356);">
                        <div class="card-body">
                            <h4 class="card-title">Jumlah User Admin: </h4>
                            <a href="data-konsultasi" class="app-brand-link">
                                <i class="menu-icon tf-icons bx bx-file"></i>
                                <h4 class="card-text">{{ $adminCount}} Users</h4>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 py-3">
                    <div class="card" style="background-color:rgb(158, 255, 113);">
                        <div class="card-body">
                            <h4 class="card-title">Jumlah User Konsultan: </h4>
                            <a href="data-konsultasi" class="app-brand-link">
                                <i class="menu-icon tf-icons bx bx-file"></i>
                                <h4 class="card-text">{{ $konsultanCount}} Users</h4>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 py-3">
                    <div class="card" style="background-color:rgba(122, 191, 255, 0.356);">
                        <div class="card-body">
                            <h4 class="card-title">Jumlah User Rawat Inap: </h4>
                            <a href="data-konsultasi" class="app-brand-link">
                                <i class="menu-icon tf-icons bx bx-file"></i>
                                <h4 class="card-text">{{ $rawatinapCount}} Users</h4>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 py-3">
                    <div class="card" style="background-color:rgb(158, 255, 113);">
                        <div class="card-body">
                            <h4 class="card-title">Jumlah User Dapur Instalasi Gizi: </h4>
                            <a href="data-konsultasi" class="app-brand-link">
                                <i class="menu-icon tf-icons bx bx-file"></i>
                                <h4 class="card-text">{{ $dapurCount}} Users</h4>
                            </a>
                        </div>
                    </div>
                </div>
