                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            <h1 class="text-center mb-0">Data User</h1>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $user->level }}</td>
                                              <td>
                                               <center> <a href="{{ route('data-edit', $user) }}" class="btn btn-primary">Edit</a></center>
                                              </td>
                                              <td>
                                              <center><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $user->id }}">Hapus</button></center>
                                              </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
